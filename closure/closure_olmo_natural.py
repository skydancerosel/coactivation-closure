"""
closure_olmo_natural.py

Closure test on the OLMo 1B natural-text Ising cluster 2 candidate.
Standard protocol (no routing stratification — OLMo 1B is dense):
- baseline (no ablation)
- ablate candidate (10 heads, L0 + L1H12)
- 5 matched-random-head controls (10 random heads each)

Output: results/olmo_1b_nat_ising/closure_test.json
"""
...
def main():
    ...
    ap.add_argument("--candidate-json", default="results/olmo_1b_nat_ising/closure_candidate.json")
    ap.add_argument("--out", default="results/olmo_1b_nat_ising/closure_test.json")
